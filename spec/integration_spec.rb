...
RSpec.describe "Integration" do
  context "without optimization" do
    it "properly parses and build the example" do
      ...
      pomdp = Aptimizer::POMDP.new(0.9, agent, opponent, public_space)
      Aptimizer::Optimizer.optimize(pomdp)

      puts Aptimizer::POMDPX::XMLBuilder.new(1, "argumentation", pomdp).build_pomdpx
    end
  end
end