...
RSpec.describe Aptimizer::Opponent do
  it "gives 0 flag with 1 rule 1 alternative" do
    ...
    opponent = Aptimizer::Opponent.new(nil, [r1])
  ...
  it "gives 0 flag with 2 rules 1 alternative" do
    ...
    opponent = Aptimizer::Opponent.new(nil, [r1, r2])
    expect(opponent.flags).to eq([])
  end
  ...
  it "gives the proper number for the flags" do
    ...
    opponent = Aptimizer::Opponent.new(nil, [r1, r2, r3])
